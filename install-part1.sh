...
pacman -S --noconfirm --needed --disable-download-timeout \
    ...
    xdg-user-dirs-gtk polkit-gnome xdg-user-dirs \
    xdg-utils gvfs gvfs-mtp playerctl pavucontrol file-roller findutils \
    ttf-font-awesome ttf-jetbrains-mono noto-fonts-emoji awesome-terminal-fonts \
    otf-font-awesome ttf-cascadia-code-nerd
