...
log_success "Post-install script created at /tmp/post_install.sh (after reboot)"
...
echo "4. Check if script exists: ls -la /tmp/post_install.sh"
echo "5. Move and run: mv /tmp/post_install.sh ~/ && ./post_install.sh"
