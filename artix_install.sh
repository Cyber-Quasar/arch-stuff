...
log_info "Run this script with: mv /tmp/post_install.sh ~/ && ./post_install.sh"
...
echo "  - Install additional utilities"log_info "Mounting filesystems..."
mount ${DISK}3 /mnt
mkdir -p /mnt/boot/efi
mount ${DISK}1 /mnt/boot/efi
...
echo "2. Reboot your system"
echo "3. Log in as ${USERNAME}"
echo "4. Move and run: sudo mv /tmp/post_install.sh ~/ && ./post_install.sh"
echo "5. Reboot again to enjoy your new Hyprland desktop!"
echo ""
log_info "The post-install script will:"
echo "  - Install Hyprland and all dependencies"
