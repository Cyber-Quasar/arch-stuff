...
# Download and setup dotfiles with Waybar configuration
log_info "Downloading dotfiles with Waybar configuration..."
cd /tmp
...
# Copy waybar configuration from the dotfiles
log_info "Setting up Waybar configuration from dotfiles..."
mkdir -p ~/.config/waybar
cp -r hypr_style1/waybar/* ~/.config/waybar/ || log_error "Failed to copy Waybar configuration"
...
apps_to_test=("hyprland" "foot" "ghostty" "waybar" "wofi" "thunar" "brave" "bpytop")
missing_apps=()
...
flatpak_apps=("com.bitwarden.desktop" "org.localsend.localsend")
...
rm -rf /tmp/yay /tmp/hyprland-dotfiles 2>/dev/null || true
